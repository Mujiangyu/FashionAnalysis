...
<div class="wrapper">
    ...
    <div class="panel" >
        ...
        <!-- 不同库，类属性待定 -->
        <%
            for (Result rowResult : tableScanner.get("category-accessories")) {
        ...
        %>
        <div class="gallery">
            <a href="background/ExtractDetailServlet?tableName=category-accessories&rowKey=${pageScope.rowKey}">
