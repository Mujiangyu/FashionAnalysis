...
<div class="wrapper">
    ...
    <ul class="nav">
        ...
        <li><a href="background/menu_bags.jsp" >Bags</a></li>
        ...
        <li><a href="background/menu_kids.jsp" >Men</a></li>
    ...
    <div class="panel" >
        ...
        <!-- 不同库，类属性待定 -->
        <%
            for (Result rowResult : tableScanner.get("category-kids")) {
        ...
        %>
        <div class="gallery">
            <a href="background/ExtractDetailServlet?tableName=category-kids&rowKey=${pageScope.rowKey}">
